...
<template>
  <div
    class="flex items-center justify-center min-h-screen bg-[url(~/assets/img/waves.svg)] bg-cover bg-center bg-no-repeat"
  >
    <form
    ...
    >
      ...
      <Button
        label="Entrar"
        type="submit"
        class="bg-red-600 h-12 text-lg font-medium"
      />
      <RouterLink
        to="/register"
        class="text-center mt-3 font-semibold hover:underline"
      >
